...
public class DislikeCommentController {
    ...
    public ResponseEntity<DislikeComment> dislikeComment(@PathVariable Long id, @RequestParam(name = "user") Long user_id) {
        ...
        if (dislikeCommentOptional.isPresent()) {
            ...
            DislikeComment dislikeComment = new DislikeComment(commentOptional.get(), userOptional.get());
