...
public class HouseController {
    ...
    public ResponseEntity<House> createHouse(@ModelAttribute HouseForm houseForm) {
        ...
        House house = new House(houseForm.getName(), houseForm.getArea(), houseForm.getLocation(), houseForm.getBedroom(), houseForm.getBathroom(), houseForm.getPrice(), houseForm.getDescription(),
